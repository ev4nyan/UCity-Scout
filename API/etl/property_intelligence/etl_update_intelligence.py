...
try:
    with psycopg.connect(DB_CONNECTION_STRING) as conn:
        ...
        with conn.cursor() as cur:
            ...
            print("ensuring the 'property_intelligence' table exists...")
            cur.execute("""
            ...
            cur.execute("CREATE INDEX IF NOT EXISTS idx_trustability ON property_intelligence(trustability_score DESC);")
            cur.execute("CREATE INDEX IF NOT EXISTS idx_risk_level ON property_intelligence(risk_level);")
            cur.execute("CREATE INDEX IF NOT EXISTS idx_landlord_locality ON property_intelligence(landlord_locality);")
